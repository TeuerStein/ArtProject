...
SECRET_KEY = '(do9hd_ul)7u4#)i@^uq4&o$!7u1px4=50v@-9431hq8^h-dz)' # here only for studing process
                                                                    # if production - SECRET_KEY will be environment variable
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(os.path.join(BASE_DIR, 'art'), 'templates'),
